        ...
        <Panel title="Matches">
          {matches.length === 0 ? (
            <div className="text-text-secondary text-xs text-center py-4">
              No matches available. Create one below!
            </div>
          ) : (
                ...
                >
                  <div>
                    ...
                    <div className="text-text-secondary text-[10px]">
                      #{m.id} &middot; {m.status}
                    </div>
                  </div>
                  <button
                    onClick={() => navigate(`/lobby?match_id=${m.id}`)}
  ...
  return (
    <div className="flex gap-2">
      <button
        ...
        className={`flex-1 px-3 py-2 text-xs rounded font-bold transition border
          ${value === "solarion"
