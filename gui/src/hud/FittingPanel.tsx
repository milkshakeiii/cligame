...
/**
 * Module definitions: what can be installed, volumes, and descriptions.
 */
...
const QUICK_FITS: Record<string, { type: string; volume?: number }[]> = {
  strike_craft: [
...
function ModuleInstaller({ ship, onClose }: { ship: Ship; onClose: () => void }) {
  ...
  const categories = ["core", "mining", "combat", "utility"] as const;
